...
import { CreatePumpDTO } from '../model/createPumpDTO';
import { Pump } from '../model/pump';
import { UpdatePumpDTO } from '../model/updatePumpDTO';
...
export class PumpService {
     ...
     */
    public create(body: CreatePumpDTO, observe?: 'body', reportProgress?: boolean): Observable<Pump>;
    public create(body: CreatePumpDTO, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Pump>>;
    public create(body: CreatePumpDTO, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Pump>>;
    public create(body: CreatePumpDTO, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Pump>('post',`${this.basePath}/pump`,
            {
                body: body,
